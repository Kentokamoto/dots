...
define(['jquery', 'underscore', '/bext/pub/backbone.js', '/util/etask.js',
    ...
    '/bext/pub/popup_lib.js', '/util/country.js',
    '/protocol/pub/countries.js', '/bext/vpn/pub/user_nav.js',
    '/svc/pub/search.js', '/util/date.js', 'backbone', '/util/user_agent.js',
    '/util/storage.js', '/bext/vpn/pub/defines.js', '/util/util.js',
    '/util/zdot.js', 'text!views/share', 'text!views/cross_sale',
    'text!views/install_exe', '/util/escape.js'],
...
function set_active_url(host, country, disable){
    var url = 'http://'+host+'/';// arik: need url_from_domain
	...
	var popular = get_popular_country();
        ...
        if (!disable && !check_before_unblock(host, country))
            return this.ereturn();
        return set_country_rule(country, !!disable, rule_enabled);
    }, function(){
	if (E.get('status')!='busy')
	    return;
...
function init_search(search_container, opt){
    ...
    var search = new zsearch.search({country: country,
        settings: Object.assign({}, opt,
    ...
    initialize: function(){
        ...
        .click(function(e){
            ...
            be_popup_lib.perr_err({id: 'be_ui_vpn_click_no_fix_it',
                info: _.extend({src_country: src_country,
...
function must_install_exe(){
    ...
    return browser=='firefox' && be_util.os_win() &&
        !E.be_mode.get('svc.detected') && version_util.version_cmp(
